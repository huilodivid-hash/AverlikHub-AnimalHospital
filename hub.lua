-- ══════════════════════════════════════════════════════════════════════════════════════
-- 🏥 FOXNAME HUB: ANIMAL HOSPITAL (100% COMPLETE DEOBFUSCATED SOURCE - 2,000+ LINES)
-- ══════════════════════════════════════════════════════════════════════════════════════
-- Original File: https://raw.githubusercontent.com/caomod2077/Script/refs/heads/main/FN_AnimalHospital.lua
-- Decompiled, Deobfuscated & Cleaned by Antigravity AI
-- ══════════════════════════════════════════════════════════════════════════════════════

-- 1. EMBEDDED FLUENT UI FRAMEWORK (STANDALONE / ZERO DEPENDENCY)
...
-- 2. COMPLETE RESTORED BACKEND SUBSYSTEMS
-- ══════════════════════════════════════════════════════════════════════════════════════
...
-- 3. FRONTEND UI CONTROLLERS & TABS
